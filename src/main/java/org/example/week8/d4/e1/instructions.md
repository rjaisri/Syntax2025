...
In this project, you will create methods with the four different access modifiers: private, default, and public. Each method will print a specific message indicating its access modifier. You will call each method from the main method, ensuring that the output is printed in a specific order.
