# Implementing Encapsulation in an Employee Information Management System
...
**Step 2: Use the `E5Encapsulation` Class to Manage Employees**

1. **In the `E5Encapsulation.java` class** that contains the main method:
    - **Main Method:**
...
- The `E5Encapsulation` class, which contains the main method, demonstrates how to set and retrieve employee information using the provided encapsulated methods.
