# Implementing Multiple Interfaces in a Smart Home Device System
...
1. **Create the `Controllable` interface** with the following:
...
1. **Create the `Configurable` interface** with the following:
    - **Unimplemented Method:**
...
1. **Create a `SmartHomeDevice` class** that implements both the `Controllable` and `Configurable` interfaces.
    - **Implement Methods:**
...
**Step 4: Test the Implementation in the `E2MultipleInterface` Class**

1. **In the `E2MultipleInterface.java` class**:
