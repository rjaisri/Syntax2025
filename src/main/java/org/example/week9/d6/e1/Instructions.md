...
## Objective
Learn how to use interfaces in Java to define behaviors that multiple
classes can implement. 
You will define an interface with methods for 
turning on and off electronic devices and implement
this interface in different device classes.
...
**Explanation:**
- The `Smartphone` and `Laptop` classes implement the `ElectronicDevice` 
- interface, providing concrete implementations for the `turnOn` and `turnOff` methods. Each device has its own specific message when these methods are called.
