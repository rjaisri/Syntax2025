# Managing a Product Catalog Using LinkedHashMap
...
1. **Create the `E2Map.java` class** with the following:
...
1. **Use a for-each loop** to iterate through the entries of the 
2. `LinkedHashMap` and print both the product name and price one by one.
